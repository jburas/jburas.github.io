(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.steve, 300, 270, 6, 0.7);
        collectable.create(type.max, 700, 410, 11, 0.9);
        collectable.create(type.grace, 475, 470, 5, 0.4);
        collectable.create(type.kennedi, 135, 150, 3, 0.9);
